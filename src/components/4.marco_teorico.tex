...
El protocolo es genérico, sin estado (\italic{stateless}) que puede ser usado para muchas tareas más allá el uso para hipertexto.
Su extensibilidad se da por sus métodos de solicitud (\italic{request methods}), códigos de error y cabeceras.
