...
\begin{enumerate}[a.]
  \item \textbf{Bash script.} Fácil interacción con los GNU-core-utils.
  \item \textbf{Python.} Lenguaje interpretado sencillo de escribir y leer.
  \item \textbf{Go.} Lenguaje compilado simple y de buen rendimiento.
\end{enumerate}
